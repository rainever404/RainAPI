...
## RainAPI upstream synchronization

For merging or continuing official New API updates, read the project skill
`.codex/skills/rainapi-upstream-sync/SKILL.md` and the current progress record
`deploy/hi-rain/upstream-sync.json` before selecting the next merge range.
